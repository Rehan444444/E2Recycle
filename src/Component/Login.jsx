...
const Login = () => {
  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img class="mx-auto h-44 w-44" src={Logo} alt="Your Company"/>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Not a member?
      <Link to='/Signup'><a href="#" class="font-semibold leading-6 text-blue-600 hover:text-blue-700"> Create a Account</a></Link>
    </p>
  </div>
</div>
    </>
